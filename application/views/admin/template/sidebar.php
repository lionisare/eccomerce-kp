    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url('dasboard') ?>">
                ...
                <div class="sidebar-brand-text mx-3">TOKO WANGUNSARI</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="<?= base_url('categori/pertanian') ?>">Pertanian</a>
                        <a class="collapse-item" href="<?= base_url('categori/peternakan') ?>">Peternakan</a>
                        <a class="collapse-item" href="<?= base_url('categori/oleholeh') ?>">Makanan & Minuman</a>
                        <a class="collapse-item" href="<?= base_url('categori/umkm') ?>">UMKM</a>
                    </div>
                </div>
            </li>
            <!-- Divider -->
